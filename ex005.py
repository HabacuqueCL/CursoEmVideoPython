...
#cm = valor * 100
#mm = valor * 1000
#print('O valor informado foi: {}\n Em centímetros: {}\n Em milímetros: {}'.format(valor, cm, mm))
...
#print('A tabuada do {} é: \n {}x1={}  {}x2={}  {}x3={} \n {}x4={} {}x5={}  {}x6={} \n {}x7={} {}x8={}  {}x9={}'.format(valor,valor,mult1,valor,mult2,valor,mult3,valor,mult4,valor,mult5,valor,mult6,valor,mult7,valor,mult8,valor,mult9))

#10 Crie um programa que leia quanto dinheiro uma pessoa na carteira e mostre quantos dolares ela pode comprar.
#valorCarteira = float(215)
#valorDolar = float(3.27)
#print('Dolar hoje: US${}'.format(valorDolar))
#print('Sua carteira: BR${}'.format(valorCarteira))
#maxCompra = valorCarteira // valorDolar
#print('Valor máximo de compra: US${}'.format(maxCompra))
...
#print('A quantidade de tinra necessaria para pintar {}m² é: {} litros '.format(valorArea, tintaNecessária))
...
#aplicarDesc = (informarDesc/100)*valorProduto
#print('Valor inicial do produto: R${}\n Valor de desconto aplicado: {}%\n Valor final do #produto: R${}'.format(valorProduto, informarDesc,aplicarDesc))
